    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-10">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-blue-800">{customer.name}</h2>
          ...
          <p className="text-gray-600">Date of Birth: {customer.dob}</p>
          <p className="text-gray-600">Nationality: {customer.nationality}</p>
          {customer.nationality === 'WNA' && <p className="text-gray-600">Country: {customer.country}</p>}
        </div>
      </div>
    </div>
  );
